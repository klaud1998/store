...
<?php endif ?>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      ...
      <input type="text" class="form-control" name='list_price' placeholder="Product Price">
      <input type="text" class="form-control" name='discount_percent' placeholder="Discount Percent">
      <input type="text" class="form-control" name='date_added' placeholder="Today's Date">
    </div>
  </div>
