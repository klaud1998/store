<?php
    ...
    require('models/basses_model.php');
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="guitars.php">Guitars <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="drums.php">Drums <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="basses.php">Basses <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
